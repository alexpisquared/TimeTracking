...
namespace TimeTracker.Common
{
  public static class Emailer
  {
    ...
    public static (int exitCode, string errMsg) PerpAndShow(string trgEmail, string subj, string body, string attachmentFilename)
    {
      var exitCode = 0;
      var report = "";
      try
      {
        var psi = new ProcessStartInfo("OUTLOOK.EXE", $"/c ipm.note /m \"{trgEmail}?v=1&subject={subj}&body={body}\" /a \"{attachmentFilename}\"") //Feb 2020: '?v=1' from https://answers.microsoft.com/en-us/msoffice/forum/all/outlook-command-line-parameters-stopped-working/7abe60b2-be29-4426-bf17-f23e1de9f04b
        {
